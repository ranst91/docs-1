...
<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
    ...
    <a href="/oss/python/integrations/providers/nvidia#sandboxed-agents-with-openshell" className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 no-underline">
