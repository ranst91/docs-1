...
- [ ] Set `integration` frontmatter (`name` is the LangChain class; omit `pypi` for N/A downloads; set `featured: true` to appear in the featured table; omit capability keys that the page does not document)
