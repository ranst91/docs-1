...
description: Integrate with the Google el carro for Oracle workloads document loader
  using LangChain Python.
integration:
  name: Google el carro for Oracle workloads
  pypi: langchain-google-el-carro
---
